    ...
    <div className="grid grid-cols-1 md:grid-cols-2 h-full relative z-10">
      ...
      <div className="hidden md:flex flex-col justify-center px-12 lg:px-16 bg-slate-50/40 border-r border-slate-100">
        ...
        <div className="flex gap-6 mt-8 border-t border-slate-200/40 pt-6">
          <div>
            <h3 className="text-xl lg:text-2xl font-bold text-blue-600">500+</h3>
            <p className="text-[11px] text-slate-400 font-medium uppercase tracking-wider">Employees</p>
          </div>
          <div>
            <h3 className="text-xl lg:text-2xl font-bold text-blue-600">25+</h3>
            <p className="text-[11px] text-slate-400 font-medium uppercase tracking-wider">Departments</p>
          </div>
          <div>
            <h3 className="text-xl lg:text-2xl font-bold text-blue-600">99%</h3>
            <p className="text-[11px] text-slate-400 font-medium uppercase tracking-wider">Efficiency</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-[360px]">
          ...
          <p className="text-center text-slate-400 text-xs mb-6">Access your HRMS dashboard</p>
