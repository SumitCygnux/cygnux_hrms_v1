...
//       {canView && <LeaveStats leaves={formattedLeaves} />}

//       {canCreate && <ApplyLeave refreshLeaves={fetchLeaves} />}

//       {canCreate && <MyLeaveHistory leaves={formattedLeaves} />}
...
const Leave = () => {
  ...
  // Add employee name in leave data
  ...
  return (
    <div>
      ...
      {/* ADMIN / HR ALL LEAVE STATS */}

      {canView && role !== "EMPLOYEE" && (
        <LeaveStats leaves={formattedLeaves} />
      )}

      {/* EMPLOYEE OWN LEAVE STATS */}

      {canView && role === "EMPLOYEE" && <LeaveStats leaves={myLeaves} />}
