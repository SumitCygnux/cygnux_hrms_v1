...
import WorkingHoursCards from "./components/WorkingHoursCards";
import NoticeBoard from "./components/NoticeBoard";
import AttendanceCalendar from "./components/AttendanceCalendar";
import AttendanceChart from "./components/AttendanceChart";
import EarlyOutReminder from "./components/EarlyOutReminder";
...
const StaffDashboard = ({
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen p-4 md:p-6">
      <div
        className="grid grid-cols-1 xl:grid-cols-[1fr_330px] gap-6"
      >
     

        <div className="space-y-6">
          <WorkingHoursCards attendance={attendance} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <EarlyOutReminder attendance={attendance} />

            <LateArrival attendance={attendance} />
          </div>
        ...
        <div>
          <StaffProfileCard profile={profile} shift={shift} />
        </div>
      </div>
    </div>
  );
